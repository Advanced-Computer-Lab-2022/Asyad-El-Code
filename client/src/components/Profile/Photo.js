import {
    Grid, Container, Typography, Paper,
    Modal, FormControl, form, OutlinedInput, Input, InputLabel,
    FormGroup, Button, IconButton, TextField, MenuItem, Select, InputAdornment
} from '@mui/material'
    ...
    return (
        <Grid container direction="column" justifyContent="center" alignContent="center" color="#1C1D1F">
            <Grid item borderBottom={1} borderColor="silver" width="100%" padding={3}>
                <Typography fontWeight="bold" fontSize={35} textAlign="center">Profile picture</Typography>
                <Typography fontSize={20} textAlign="center">Update your photo</Typography>
            </Grid>
            {/* <Grid item borderBottom={1} borderColor="silver" width="100%" padding={3}>
